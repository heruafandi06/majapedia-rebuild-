...
@section('content')
<title>Majapedia | Ubah Alamat </title>
                  ...
                  <div class="card-body">
                      ...
                      <form method="POST" action="">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="jenis_alamat" type="text" class="form-control @error('jenis_alamat') is-invalid @enderror" name="jenis_alamat" value="{{ $alamat->jenis_alamat }}" required autocomplete="jenis_alamat" autofocus placeholder="Contoh: Alamat rumah, kantor, dsb.">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <select id="provinsi" type="text" class="form-control @error('provinsi') is-invalid @enderror" name="provinsi" required autocomplete="provinsi" onchange="pilih_kota(this.value);">
                                      <option value="{{ $alamat->provinsi['province_id'] }}">{{ $alamat->provinsi['province'] }}</option>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <select id="kota" type="text" class="form-control @error('kota') is-invalid @enderror" name="kota" required autocomplete="kota">
                                      <option value="{{ $alamat->kabupaten['city_id'] }}">{{ $alamat->kabupaten['city_name'] }}</option>
                                  </select>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="kode_pos" type="text" class="form-control @error('kode_pos') is-invalid @enderror" name="kode_pos" value="{{ $alamat->kode_pos }}" required autocomplete="kode_pos">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <textarea id="alamat_lengkap" class="form-control @error('alamat_lengkap') is-invalid @enderror" name="alamat_lengkap" required autocomplete="alamat_lengkap">
                                      {{ $alamat->alamat }}
                                  </textarea>
